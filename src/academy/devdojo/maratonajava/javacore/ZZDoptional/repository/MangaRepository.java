...
public class MangaRepository {
    private static List<Manga> mangas = List.of(new Manga(1, "One piece", 1000), new Manga(2, "Dragon Ball", 500));

    public static Optional<Manga> findByTitle(String title) {
        return findBy(manga1 -> manga1.getTitle().equalsIgnoreCase(title));
    }
